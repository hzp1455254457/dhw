...
public class NumberEffect1 : MonoBehaviour
{
    public Text text;
   // int currentCount;
   ...
   //int targetCount;
    ...
    public void Animation(float taget, string left,string right,float time=1f, float initCount=0,UnityEngine.Events.UnityAction unityAction=null)
    {
   ...
   public virtual void SetText(string left ,float value2,string right)
    {

    
        text.text = string.Format("{0}{1:F2}{2}", left, value2, right);
    }
}
